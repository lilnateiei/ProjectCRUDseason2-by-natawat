...
const validateData = (exserciseData) => {
  if (!exserciseData.muscle) {
    Swal.fire({
      text: 'กรุณากรอกบริเเวณกล้ามเนื้อ',
      icon: 'warning',
      confirmButtonText: 'ตกลง'
    });
    return false;
...
const submitData = async () => {
  ...
  try {
    ...
    Swal.fire({
      ...
      window.location.href = "./exercise.html"; // กลับไปที่หน้าหลักหลังจากกดตกลง
    });
